...
function Analysis({
  ...
  const calculateRiskMetrics = useCallback(() => {
    ...
    const reqTur = parseFloat(sessionData.uncReq.neededTUR);
    ...
    let tarResult = calcTAR(uutNominal.value, 0, LLow, LUp,9.4,10.6);
    let turResult = calcTUR(uutNominal.value, 0, LLow, LUp,calcResults.expanded_uncertainty_absolute_base);
    let pfaResult = PFAMgr(uutNominal.value, 0, LLow, LUp, calcResults.combined_uncertainty_absolute_base, reliability, turResult ,turNeeded)[0];
    let pfrResult = PFRMgr(uutNominal.value, 0, LLow, LUp, calcResults.combined_uncertainty_absolute_base, reliability, turResult ,turNeeded)[0];

    console.log("TAR:", tarResult);
    console.log("TUR:", turResult);
    console.log("PFA:", pfaResult);
    console.log("PFR:", pfrResult);

    console.log("Comb Unc:", calcResults.combined_uncertainty_absolute_base)
    ...
    console.log("gbHigh:", gbHigh);
    console.log("gbMult:", gbMult);
    console.log("gbPFA:", gbPFA);
    console.log("gbPFAT1:", gbPFAT1);
    console.log("gbPFAT2:", gbPFAT2);
    console.log("gbPFR:", gbPFR);
    console.log("gbPFRT1:", gbPFRT1);
    console.log("gbPFRT2:", gbPFRT2);
    ...
    const newRiskMetrics = {
      ...
      tmdeToleranceHigh: 0,
      tmdeToleranceLow: 0,
      uutBreakdownForTar: 0,
      tmdeBreakdownForTar: 0,
      nativeUnit: 0,
      gbResults: 0
    };
