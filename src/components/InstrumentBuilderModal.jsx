      ...
      return (
        <div className="modal-overlay">
            ...
            <div className="modal-content" style={{ maxWidth: "1000px", height: "85vh", display: 'flex', flexDirection: 'column' }}>
                <div style={{display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom: '15px'}}>
                    <h3><FontAwesomeIcon icon={faRadio} style={{marginRight: '10px'}}/> Instrument Library</h3>
                    ...
                    <table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem'}}>
                        ...
                        <tbody>
                                            ...
                                            <td style={{padding:'12px', textAlign: 'center'}}>
                                                <div style={{display: 'flex', justifyContent: 'center', gap: '10px'}}>
                                                    <button 
                                                        ...
                                                        onClick={(e) => handleEditExisting(e, inst)} 
                                                    ...
                                                    <button 
                                                        ...
                                                        onClick={(e) => handleDeleteInstrument(e, inst.id)} 
                                                        title="Delete Instrument"
                                                                        ...
                                                                        <tbody>
                                                                            {func.ranges.map((range, idx) => (
                                                                                <tr key={range.id || idx} style={{ borderBottom: "1px solid var(--border-color)" }}>
                                                                                    ...
                                                                                    <td style={{ padding: "8px", fontFamily: "monospace", color: "var(--primary-color)" }}>
                                                                                        {renderToleranceString(range.tolerances)}
                                                                                    </td>
                                                                                </tr>
                                                                            ))}
                                                                            {func.ranges.length === 0 && <tr><td colSpan="4" style={{padding:'10px', textAlign:'center', fontStyle:'italic', color:'var(--text-color-muted)'}}>No ranges defined.</td></tr>}
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                                            );
                            ...
                            {filteredInstruments.length === 0 && (
                                <tr><td colSpan="5" style={{textAlign: 'center', padding: '20px', color: 'var(--text-color-muted)'}}>No instruments found.</td></tr>
                            )}
                        </tbody>
                    </table>
                </div>
      ...
      <div className="modal-content" style={{ maxWidth: "1000px", height: "90vh", display: 'flex', flexDirection: 'column' }}>
        <div style={{display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom: '15px'}}>
            <div style={{display:'flex', alignItems:'center', gap:'10px'}}>
                <button className="icon-action-btn" onClick={() => setViewMode("list")} title="Back to Library"><FontAwesomeIcon icon={faArrowLeft}/></button>
                <h3 style={{margin:0}}>Edit Instrument</h3>
            </div>
            <button onClick={onClose} className="modal-close-button" style={{position:'static'}}>&times;</button>
        </div>
